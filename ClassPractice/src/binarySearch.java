...
public class binarySearch {
	public static void main(String[] args) {
		...
		// in ascending order.
		int numbers[] = { 101, 142, 147, 189, 199, 207, 222, 234, 289, 296, 310, 319, 388, 394, 417, 429, 447, 521, 536,
				600 };
	 ...
	 * array is searched for the number passed to value. If the number is found, its
	 * array subscript is returned. Otherwise, -1 is returned indicating the value
